            ...
            {[
              {
                title: "Steel Beams",
                description:
                  "High-quality structural steel beams for construction",
                image: "/placeholder.svg?height=200&width=300",
                link: "/products?category=beams",
              },
              {
                title: "Steel Plates",
                description: "Premium steel plates for industrial applications",
                image: "/placeholder.svg?height=200&width=300",
                link: "/products?category=plates",
              },
              {
                title: "Steel Pipes",
                description: "Durable steel pipes for various industries",
                image: "/placeholder.svg?height=200&width=300",
